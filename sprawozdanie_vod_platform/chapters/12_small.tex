Poniższy wykres przedstawia zbiorczy widok wpływu indeksów na
wszystkie 24 scenariusze pogrupowane po kategoriach CRUD na wolumenie
\emph{small}. Słupki jednolite oznaczają wariant bez indeksów,
słupki ze szrafurą -- wariant z indeksami; oś Y jest logarytmiczna,
żeby pokazać scenariusze rozciągające się od ułamków milisekundy
po setki milisekund w jednym widoku.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{charts/index_comparison_small.png}
    \caption{Wpływ indeksów na wydajność -- wolumen \emph{small}.}
\end{figure}
...
MongoDB jest tu wielokrotnie szybszy od pozostałych silników --
0.9~ms wobec 17--25~ms u konkurencji. Powód jest prosty: w modelu dokumentowym serial
...
Na małym wolumenie wszystkie cztery silniki kończą zapytanie w
1.4--7~ms, więc różnice między wariantami są niewielkie.
