Wykres zbiorczy dla wolumenu \emph{medium} -- analogiczny do tego
z 12.1, ale na pięciokrotnie większym zbiorze. Tu zaczynają się
wyraźnie ujawniać dysproporcje między bazami i wpływ indeksów.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{charts/index_comparison_medium.png}
    \caption{Wpływ indeksów na wydajność -- wolumen \emph{medium}.}
\end{figure}
