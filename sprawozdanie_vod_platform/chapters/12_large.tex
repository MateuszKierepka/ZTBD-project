Wykres zbiorczy dla wolumenu \emph{large} -- 10 milionów rekordów --
najbardziej wyrazisty z trzech. Słupki bez szrafury (bez indeksów)
dla niektórych scenariuszy sięgają sekund, podczas gdy słupki ze
szrafurą (z indeksami) pozostają w milisekundach -- to wizualne
podsumowanie pierwszej części hipotezy badawczej.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{charts/index_comparison_large.png}
    \caption{Wpływ indeksów na wydajność -- wolumen \emph{large}.}
\end{figure}
