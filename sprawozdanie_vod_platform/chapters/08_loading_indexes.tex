...
i kolekcji \emph{bez indeksów wtórnych}, a dopiero w drugim kroku -- po
...
dotyczy to wyłącznie indeksów wtórnych przyspieszających scenariusze SELECT.
...
najpierw na bazie bez indeksów wtórnych, a następnie po ich założeniu,
...
budowa zestawu indeksów wtórnych. Dobór indeksów został podporządkowany
...
Loader \texttt{postgres\_loader.py} tworzy 17 indeksów wtórnych,
...
Loader \texttt{mysql\_loader.py} tworzy 10 indeksów wtórnych
...
bazę odpytać w dwóch wariantach -- bez i z indeksami wtórnymi --
...
(bez indeksów wtórnych)~$\rightarrow$~\emph{benchmark}~$\rightarrow$
